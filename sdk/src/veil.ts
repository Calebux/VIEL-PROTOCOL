...
import { createNote, serializeNote, type VeilNote, encryptNote } from "./note";
...
export class VeilClient {
   ...
   *
   * @param note - The VeilNote to withdraw
  ...
  private ensureInit(): void {
    if (!this.initialized) {
      throw new Error("VeilClient not initialized — call init() first");
    }
  }
}
